...
7. **알림톡 운영** 모듈을 켜고 승인 템플릿을 등록한다. 발송 전 이 환경의 발송을 허용한다.
...
GNUCMS 운영 모듈의 **웹발송**은 관리자가 브라우저에서 번호·템플릿·변수를 입력하고
...
`./vendor/bin/phpunit tests/Web/AlimtalkTest.php`, `./vendor/bin/phpunit tests/Extension`.
